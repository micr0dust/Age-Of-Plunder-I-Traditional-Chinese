...
execute @e[tag=red1,r=5] ~ ~ ~ /clone 8 42 -100 14 47 -106 ~-3 ~ ~-3 replace force
...
execute @e[tag=red3,r=6] ~ ~ ~ /clone -19 43 -100 -13 50 -106 ~-3 ~ ~-3 replace force

execute @e[tag=blue4,r=5] ~ ~ ~ /clone -38 43 -88 -30 46 -96 ~-4 ~ ~-4 replace force
execute @e[tag=red4,r=5] ~ ~ ~ /clone -38 43 -99 -30 46 -107 ~-4 ~ ~-4 replace force
