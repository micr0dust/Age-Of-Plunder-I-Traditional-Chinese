...
execute @a[score_stop=0,score_stop_min=0] ~ ~ ~ /tellraw @p[team=blue] {"text":"[___\u66ab\u505c___]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bluestop set 1"}}
execute @a[score_stop=1,score_stop_min=1] ~ ~ ~ /tellraw @p[team=blue] {"text":"[__\u7e7c\u7e8c\u904a\u6232__]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bluekeep set 1"}}
